...
<html>
	...
	<div style="padding:8px;">
			...
			<tbody>
				<tr>
					<td width="100%" align="center">
						...
						<h3><u><strong>S U R A T  K E T E R A N G A N</strong></u></h3>
						
						<p>Nomor : SK/01/01/Dit Lantas</p>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<p>
		Telah melaporkan dan beroperasi di Wilayah <strong>Polda Sulut</strong> selama <?php
$datetime1 = date_create($model->berlaku);
$datetime2 = date_create($model->sampai);
$interval = date_diff($datetime1, $datetime2);
echo $interval->format('%m');
?>	Bulan<br/>
		Terhitung tanggal dikeluarkan <strong>Surat Keterangan</strong> ini sampai tanggal {{ date("d-M-Y", strtotime($model->sampai)) }}<br/>
		Adapun identitas kendaraan bermotor yang digunakan sebagai berikut :
		...
		<table width="100%" border="0">
			...
			<tr>
				...
				<td>
					<strong>Nama Pemakai</strong>
				</td>
				<td>
					<strong>:</strong>
				</td>
				<td>
					<strong>{{ $model->pemakai }}</strong>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<strong>Alamat Pemakai</strong>
				</td>
				<td>
					<strong>:</strong>
				</td>
				<td>
					<strong>{{ $model->alamat_pemakai }}</strong>
				</td>
			</tr>
		</table>
		...
		<p>Demikian <strong>Surat Keterangan</strong> ini diberikan kepada yang bersangkutan untuk dapat dipergunakan sebagaimana mestinya. </p>
		...
		<table width="100%" border="0">
			<tr>
				...
				<br/><br/>
					...
					<ol>
						<li>Setelah selesai masa berlakunya Surat Keterangan ini, Kendaraaan segera dimutasikan;</li>
						<li>Surat Keterangan ini bukan sebagai penganti STNK;</li>
						<li>Surat ini tidak menjamin pelanggaran dan kecelakaan Lalu Lintas serta lain-lain yang bertentangan dengan peraturan / Undang-Undang.</li>
</li>

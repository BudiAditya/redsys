                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title">
                                    ...
                                    <h4 class="float-left">Edit Pekerja</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body  p-xl-3">
										...
										<form class="form-horizontal" action="{{ route('pekerja.update', $datas->id) }}" method="post">
										{{ csrf_field() }}
										{{ method_field('PUT') }}
                                            ...
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">No HP</label>
                                                ...
                                                <div class="col-lg-8">
												                            <input type="text" name="hp_no" placeholder="No HP" value="{{ $datas->hp_no }}" class="form-control"> 
                                                </div>
                                            </div>
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Status Pekerja</label>
                                              <div class="col-lg-8">
                                                ...
                                                @if($datas->status==1)
                                                    <option value="1" selected>Sub Kontrak</option>
                                                    <option value="2">Bas Developert</option>
                                                @else
                                                    <option value="1">Sub Kontrak</option>
                                                    <option value="2" selected>Bas Developert</option>
                                                @endif
                                                </select>
                                              </div>
                                            </div>

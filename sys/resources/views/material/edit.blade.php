                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title">
                                    ...
                                    <h4 class="float-left">Edit Material</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body  p-xl-3">
										...
										<form class="form-horizontal" action="{{ route('material.update', $data->id) }}" method="post" enctype="multipart/form-data">
										{{ csrf_field() }}
										{{ method_field('PUT') }}
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Kode</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="kode" placeholder="Kode" class="form-control" value="{{$data->kode}}" required> 
                                              </div>
                                            </div>
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Kategori</label>
                                              <div class="col-lg-8">
                                                ...
                                                @foreach($kategorimaterials as $kategorimaterial)
                                                    @if($kategorimaterial->id == $data->kategori_material->id)
                                                        <option value="{{$kategorimaterial->id}}" selected="">{{$kategorimaterial->kategori}}</option>
                                                    @else
                                              ...
                                              <div class="col-lg-8">
                                                ...
                                                @foreach($suppliers as $supplier)
                                                    @if($data->supplier!=null)
                                                        @if($supplier->id == $data->supplier->id)
                                            ...
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Nama Barang</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="nama_brg" placeholder="Nama Barang" class="form-control" value="{{$data->nama_brg}}" required> 
                                              </div>
                                            </div>
                                            <!-- <div class="form-group row"><label class="col-lg-2 form-control-label">Ukuran</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="ukuran" placeholder="Ukuran" class="form-control" value="" required> 
                                              </div>
                                            </div> -->
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Satuan</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="satuan" placeholder="Satuan" class="form-control" value="{{$data->satuan}}"required> 
                                              </div>
                                            </div>
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Harga</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="harga" placeholder="Harga" class="form-control" value="{{$data->harga}}" required> 
                                              </div>
                                            </div>                                            
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">Keterangan</label>
                                              <div class="col-lg-8">
                                                <input type="text" name="keterangan" class="form-control" value="{{$data->keterangan}}" />
                        												<!-- <textarea class="form-control" name="keterangan" id="" cols="30" rows="10">{{$data->keterangan}}</textarea> -->
                                              </div>
                                            </div>
                                            <!-- <div class="form-group row"><label class="col-lg-2 form-control-label">Stock</label>
                                              <div class="col-lg-8">
                                                ...
                                                <option value="0" {{$data->is_stock == 0 ? 'selected' : ''}}>Tidak Tersedia</option>
                                                <option value="1" {{$data->is_stock == 1 ? 'selected' : ''}}>Tersedia</option>
                                                </select>
                                              </div>
                                            </div> -->
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">File Gambar</label>
                                              <div class="col-lg-8">
                                                ...
                                                Current Images: {{$data->material_pic}}
                                              </div>
                                            </div>

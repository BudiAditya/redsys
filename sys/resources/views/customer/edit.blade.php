                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body  p-xl-3">
										...
										<form class="form-horizontal" action="{{ route('customer.update', $datas->id) }}" method="post">
										{{ csrf_field() }}
										{{ method_field('PUT') }}
                                            ...
                                            <div class="form-group row"><label class="col-lg-2 form-control-label">ID Card</label>

                                                <div class="col-lg-8">
												                            <input type="text" name="id_card" placeholder="No Identitas" value="{{ $datas->id_card }}" class="form-control"> 
                                                </div>
                                            </div>

                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title">
                                    ...
                                    <h4 class="float-left">Edit Kategori Material</h4>

                                    <ol class="breadcrumb float-left float-md-right">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);"><i class="fa fa-home"></i></a></li>
                                        <li class="breadcrumb-item">Kategori Material</li>
                                    </ol>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-card margin-b-30">
                                    ...
                                    <div class="panel-body  p-xl-3">
										...
										<form class="form-horizontal" action="{{ route('katmaterial.update', $datas->id) }}" method="post">
										{{ csrf_field() }}
										{{ method_field('PUT') }}
